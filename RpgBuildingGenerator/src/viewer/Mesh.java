...
public class Mesh {
    ...
    public Mesh(GL4 gl, float[] positions, float[] textCoords, float[] normals, int[] indices) {
        ...
        try {
            ...
            gl.glBufferData(GL4.GL_ARRAY_BUFFER, positions.length * 4, posBuffer, GL_STATIC_DRAW);
            ...
            gl.glBindBuffer(GL4.GL_ARRAY_BUFFER, vboIds[0]);
            gl.glBufferData(GL4.GL_ARRAY_BUFFER, textCoords.length * 4, textCoordsBuffer, GL_STATIC_DRAW);
            ...
            gl.glBindBuffer(GL4.GL_ARRAY_BUFFER, vboIds[0]);
            gl.glBufferData(GL4.GL_ARRAY_BUFFER, normals.length * 4, vecNormalsBuffer, GL_STATIC_DRAW);
            ...
            gl.glBufferData(GL4.GL_ELEMENT_ARRAY_BUFFER, indices.length * 4, indicesBuffer, GL_STATIC_DRAW);
...
//            glVertexAttribPointer(2, 3, GL_FLOAT, false, 0, 0);
    ...
    public void render(GL4 gl) {
        ...
        gl.glDrawElements(GL_TRIANGLES, getVertexCount(), GL_UNSIGNED_INT, 0);
